...
<body>
    <div class="upload-container">
        ...
        function checkMagicBytes($filePath) {
            ...
            // PNG dosyası için kontrol
            if (strpos($bytes, "\x89\x50\x4E\x47\x0D\x0A\x1A\x0A") === 0) {
                return true;
            }
            
            // JPEG dosyası için kontrol
        ...
        if (isset($_POST["submit"])) {
            ...
            // Dosya türünü magic byte ile kontrol et
            if (!checkMagicBytes($_FILES["file"]["tmp_name"])) {
                $message = "Sadece PNG veya JPEG dosyaları yüklenebilir.";
                $uploadOk = 0;
            }
